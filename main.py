...
from dataset import Image_Dataset, denorm
...
def main(args):
    ...
    if args.do_train:
        train_dataset = Image_Dataset(args.train_content_dir,args.train_style_dir, args.max_train_samples, args.model)
...
def parse_args():
    ...
    parser.add_argument("--model_path", type=str, default="./out_T5/check-5_model.pth")
